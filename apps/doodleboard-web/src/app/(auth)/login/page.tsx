...
import { setCookie } from '@/actions/auth-actions/login';
  ...
  return (
    <div className="mx-auto my-auto w-1/4 flex-1 flex flex-col gap-12 items-center justify-center text-primary">
      ...
      <div className='flex flex-col gap-2 items-center justify-center w-full text-center px-4'>
        <h4 className='font-medium text-3xl'>Yooo, welcome back!</h4>
        <p className='text-primary/70 text-sm tracking-wide'>First time here? <Link href='/signup' className='text-primary hover:underline transition-all duration-300'>Sign up for free</Link></p>
      </div>
      ...
      <div className='flex flex-col items-center justify-center gap-6 w-full'>
        <div className='flex gap-1.5 w-full items-center justify-center px-12'>
          ...
          <p className='text-xs text-primary/80'>Or sign in with</p>
          <div className='bg-primary/30 py-[0.1px] flex-1'/>
        </div>
