...
export default function Gradients() {
  return (
    <>
      <div className='absolute -bottom-10 -left-50 w-120 h-120 bg-linear-to-tr rotate-45 from-primary/90 from-10% via-subtle/70 via-30% to-base to-80% blur-3xl'></div>
